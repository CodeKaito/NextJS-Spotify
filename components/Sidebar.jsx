...
function Sidebar({ view, setView, setGlobalPlaylistId }) {
  ...
  return (
    <div className='w-64 text-neutral-400 grow-0 shrink-0 h-screen overflow-hidden border-r border-neutral-900 flex flex-col p-5 space-y-4'>
...

        {
            playlists.map((playlist) => {
                ...
                onClick={() => {
                    ...
                    key={playlist.id} className='cursor-default hover:text-white w-52'>
                        {playlist.name}
                </p>
                )
            })
